-- The below is for local development testing purposes. Intended for use with `seed.sql`
-- From https://github.com/orgs/supabase/discussions/5043#discussioncomment-6408329
